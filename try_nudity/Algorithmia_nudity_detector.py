...
def sending_requests(path, folder, image):
	...
	folder_space = folder.replace(" ", "_")

	date_folder_path = "data://irisong980912/" + folder_space
	# print("nlp_directory: " + date_folder_path)
	# Instantiate a DataDirectory object, set your data URI and call create
	nlp_directory = client.dir(date_folder_path)
	...
	image_file = "data://irisong980912/" + "folder_space/" + image

	print("image_file: " + image_file)

	if client.file(image_file).exists() is False:
	    # Upload local file
	    client.file(image_file).putFile(path)
...
if __name__ == '__main__':
    ...
    print("yes")
    sending_requests(args.path, args.folder, args.image)
